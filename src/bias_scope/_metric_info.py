...
METRIC_INFO: dict[str, MetricInfo] = {
    ...
    "AnalogicalReasoningBias": MetricInfo(
        ...
        deviation_note=(
            ...
            "not publish a general noun parser, derivative table, demonym lexicon, or "
            ...
            "Its metadata range describes an individual reported frequency, not an "
            "aggregate score. "
    ...
    "CrowSPairs": MetricInfo(
        ...
        reference_impl=("https://github.com/nyu-mll/crows-pairs @ 8aaac11c4854"),
        resource_binding="dataset",
        deviation_note=(
    ...
    "DemographicRepresentation": MetricInfo(
        ...
        fidelity="adaptation",
        reference=(
            "Holistic Evaluation of Language Models, TMLR 2023 — https://arxiv.org/abs/2211.09110"
        ),
    ...
    "FGB": MetricInfo(
        ...
        reference_impl=("https://github.com/facebookresearch/ResponsibleNLP @ 0ec714eb0842"),
        resource_binding="classifier",
        deviation_note=(
    ...
    "LPBS": MetricInfo(
        ...
        reference_impl=(
            "https://github.com/keitakurita/contextual_embedding_bias_measure @ 18044f87e2ff"
        ),
        resource_binding="dataset",
        deviation_note=(
    ...
    "ToxicityFraction": MetricInfo(
        ...
        fidelity="original",
        reference=(
            "BiasScope original. Inspired by Gehman et al. 2020 — https://arxiv.org/abs/2009.11462"
        ),
        reference_impl="https://github.com/allenai/real-toxicity-prompts @ dd44ab77ed8b",
        resource_binding="classifier",
        deviation_note=(
    ...
    "TruthfulQA": MetricInfo(
        ...
        reference_impl=(
            ...
            "8b48f682acc3a71cd04e32e46e6da40ddb1a5860 (preserved v0)"
        ),
        resource_binding="dataset",
        deviation_note=(
    ...
    "ImplicitAssociationTest": MetricInfo(
        ...
        reference_impl=("https://github.com/baixuechunzi/llm-implicit-bias @ 0d2772e8eb21"),
        resource_binding="dataset",
        deviation_note=(
