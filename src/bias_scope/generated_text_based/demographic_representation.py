...
from typing import Sequence, Mapping, Optional, Literal, Dict
import numpy as np
    ...
    def evaluate(
        ...
        *,
        ...
        if normalize not in {"mentions", "tokens"}:
            raise ValueError(f"normalize must be 'mentions' or 'tokens', got '{normalize}'")
        ...
        if compare_to is not None:
            ...
            jsd = float(0.5 * np.sum(p_smooth * np.log(p_smooth / m)) +
