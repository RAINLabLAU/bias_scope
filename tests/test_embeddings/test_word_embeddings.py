"""Tests for word embedding metrics (WEAT)."""
...
class TestWEAT:
    ...
    def test_oo_and_functional_api_equivalence(self):
        ...
        oo_score = WEAT().compute((target1, target2), (attr1, attr2))
        func_score = weat((target1, target2), (attr1, attr2))
        
        assert oo_score == func_score
